...
# Skip lime git clone as it may fail - use installed version instead
# haxelib git lime https://github.com/mcagabe19-stuff/lime --quiet || true

haxelib install lime 8.2.0 --quiet 2>/dev/null || haxelib install lime --quiet 2>/dev/null || true
haxelib install hxcpp --quiet 2>/dev/null || haxelib git hxcpp https://github.com/mcagabe19-stuff/hxcpp --quiet || true
haxelib install openfl 9.3.3 --quiet 2>/dev/null || true
haxelib install flixel 5.6.0 --quiet 2>/dev/null || haxelib git flixel https://github.com/MobilePorting/flixel 5.6.1 --quiet || true
